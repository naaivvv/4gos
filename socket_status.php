...
<div class="text-md bold grid grid-cols-1 lg:grid-cols-2 gap-2 px-6">
                    <div class="p-2">
                        ...
                        <p class="px-8 text-md font-medium text-stone-700"><span id="wifi-ssid">Loading...</span></p>
                        <p class="thin italic px-8 text-sm text-cyan-600"><span id="esp32-ip">Loading...</span></p>
                        <ul class="mt-6">
                    ...
                    <div class="p-2 lg:text-right text-left">
                        <h4 class="mt-4 temp-status text-5xl font-bold">Loading...</h4>
